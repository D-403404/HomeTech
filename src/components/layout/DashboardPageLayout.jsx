  ...
  return (
    <div className="flex justify-center items-center">
      <div className="relative h-[460px] w-[506px] flex justify-center items-center">
        ...
        <div className="absolute bottom-0 left-[-15px] font-[Adamina] text-[40px]">
          {range[0]}
        </div>
        <div className="absolute bottom-0 right-[-35px] font-[Adamina] text-[40px]">
          {range[1]}
        </div>
        <div className="font-[Adamina] text-[100px] z-50">
          {value !== null ? value.toFixed(1).toString() + unit : "N/A"}
        </div>
        {value !== null && (
          <div
